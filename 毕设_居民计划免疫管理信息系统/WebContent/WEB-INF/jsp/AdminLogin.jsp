...
<html>
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin" id="form" action="AdminLogin.do" method="post">
        <h2 class="form-signin-heading">工作人员登录</h2>
        <label class="sr-only">用户名</label>
        <input type="text" id="loginName" name="administrator_name" class="form-control" placeholder="admin" required autofocus>
        <label for="inputPassword" class="sr-only">密码</label>
        <input type="password" name="administrator_password" id="pwd" class="form-control" placeholder="password" required>
        <div class="checkbox">
          <label>
